...
#define g_mids        0x40
#define g_black       0xFF
#define g_contrast    0xFF
#define g_brightness  0x00
#define g_saturation  0xCE
#define g_greys       0x00
...
static char ief_set2[3] = {0x72, 0x01, 0x00};
static char ief_set3[4] = {0x73, 0x00, 0x00, 0x00};
static char ief_set4[4] = {0x74, 0x00, 0x00, 0x00}; //{0x74, 0x04, 0x01, 0x00};
static char ief_set5[4] = {0x75, 0x00, 0x00, 0x00}; //{0x75, 0x03, 0x0F, 0x00};
static char ief_set6[4] = {0x76, 0x00, 0x00, 0x00}; //{0x76, 0x07, 0x00, 0x04};
static char ief_set7[9] = {0x77, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40}; //{0x77, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40};                                     
static char ief_set8[9] = {0x78, 0x3D, 0x3D, 0x3D, 0x3D, 0x3D, 0x3D, 0x3D, 0x3D}; //{0x78, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C};  //new: for I-pjt LCD tunning.;     
static char ief_set9[9] = {0x79, 0x3B, 0x3B, 0x3B, 0x3B, 0x3B, 0x3B, 0x3B, 0x3B};//{0x79, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40};                                      
...
//camera mode
#ifdef LGIT_IEF_SWITCH
static char ief_set10[2] = {0x70, 0x00};                             
